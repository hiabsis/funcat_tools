...
# 数据保存的根目录位置
from main.config import DATA_ROOT_DIR, TUSHARE_TOKEN
...
# tushare 大盘指数每日指标
# 单次限量3000条（即，单一指数单次可提取超过12年历史）
# api: https://tushare.pro/document/2?doc_id=128
TUSHARE_INDEX_FIELDS = 'ts_code,trade_date,turnover_rate,pe,pe_ttm,pb,turnover_rate,turnover_rate_f,free_share,float_share,total_share,float_mv,total_mv'
...
# pro = ts.pro_api(TUSHARE_TOKEN)
#
# df = pro.index_dailybasic(trade_date='20220817', fields='ts_code,trade_date,turnover_rate,pe')
# for i, r in df.iterrows():
#     print(r.values)
# print(get_stock_index_from_tu_share('600605.SH'))
# print(get_stock_index_from_tu_share('000905.SH'))
